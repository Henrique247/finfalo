  ...
  const handleSend = async (messageText: string) => {
    ...
    try {
      ...
      setMessages(prev => [
        ...
        {
          role: 'model',
          text: 'Oops! Encontrei um problema ao contactar o servidor do FinBot. Por favor, garante que a chave do Gemini está inserida nos Segredos e tenta novamente.'
        }
      ]);
    } finally {
      setLoading(false);
