    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#053259] via-[#064a7f] to-[#0869A6] p-4 sm:p-6 text-white shadow-xl border border-[#0869A6]/40 transition-all">
        ...
        <div className="flex items-center justify-between relative z-10 gap-2">
          ...
          <div className="flex items-center gap-1 bg-white/10 backdrop-blur-md px-2.5 py-1 rounded-full border border-white/15 text-[9px] sm:text-xs text-slate-100 font-mono shrink-0 font-bold">
            <span className="w-1.5 h-1.5 rounded-full bg-[#51a629]"></span>
            <span>FinFalo Pessoal</span>
          </div>
        </div>
