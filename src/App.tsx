...
export default function App() {
  ...
  const updateFinancials = (transactionsList: Transaction[], goalsList: Goal[], budgetsList: Budget[]) => {
    ...
    // Points based on: savings rate, budget limits, transaction ratio
    let score = 80;
    if (transactionsList.length === 0) {
      ...
      const exceededBudgetsCount = updatedBudgets.filter(b => b.limit > 0 && b.spent > b.limit).length;
      score -= exceededBudgetsCount * 12;
    }
